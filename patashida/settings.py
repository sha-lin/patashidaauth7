"""
Django settings for patashida project.
...
SECRET_KEY = 'django-insecure-no-3aw@%w0$*s3iez-4mfv77(s*51m%uff$f*n0bi06d_cq0kr'
...
WSGI_APPLICATION = 'patashida.wsgi.application'
